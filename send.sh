...
if [ "$PREPARER" -eq 1 ]; then
	...
	# Step 1
	qwoynd tx bank multi-send ${PermanentLockedAccount} ${TO_1} ${TO_2} ${TO_3} 2140000000uqwoyn --gas-prices 0.0025uqwoyn --gas-adjustment 1.3 --generate-only >> "step1_send.json"
