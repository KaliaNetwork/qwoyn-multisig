...
if [ "$PREPARER" -eq 1 ]; then
	...
	# Step 1
	qwoynd tx bank send ${PermanentLockedAccount} ${TO_1} 2140000000uqwoyn --from ${BaseAccount} --gas-prices 0.0025uqwoyn --gas-adjustment 1.3 --generate-only >> "step1_send.json"
